...
class SnliProcessor(DataProcessor):
  ...
  def get_test_examples(self, data_dir, dataset):
    """See base class."""
    return self._create_examples(
        self._read_tsv(os.path.join(data_dir, dataset + ".tsv")), "test")
...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='train', help="Predicting on train/val/test dataset")
    parser.add_argument('--domain', type=str, default='S-Flo', help="S-Flo or U-Flo predictions")
    ...
    if args.do_predict:
        eval_examples = processor.get_test_examples(args.data_dir, args.dataset)
        eval_features = convert_examples_to_features(
            eval_examples, label_list, args.max_seq_length, tokenizer,srl_predictor=srl_predictor )
